...
class Info extends Controller {
	...
	function player_class($var) {
		...
		elseif ($var == 'ENGINEER') return '<img src="'.Yii::app()->homeUrl.'/images/top/cleric.png" alt="" title="Technist" />';
		elseif ($var == 'GUNSLINGER') return '<img src="'.Yii::app()->homeUrl.'/images/top/gunslinger.png" alt="" title="Gunslinger" />';
		elseif ($var == 'RIDER') return '<img src="'.Yii::app()->homeUrl.'/images/top/aethertech.png" alt="" title="Aethertech" />';
		elseif ($var == 'MUSE') return '<img src="'.Yii::app()->homeUrl.'/images/top/muse.png" alt="" title="Muse" />';
	...
	function class_text($var) {
		...
		elseif ($var == 'ENGINEER') return 'Technist';
		elseif ($var == 'GUNSLINGER') return 'Gunslinger';
		elseif ($var == 'RIDER') return 'Aethertech';
		elseif ($var == 'MUSE') return 'Muse';
		elseif ($var == 'BARD') return 'Songweaver';
		else return '???';
	}
