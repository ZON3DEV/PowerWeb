	...
	*/
	...
	public function rules()
	{
		return array(
			...
			//array('activated, access_level, membership, last_server, donatemoney', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, password, activated, access_level, membership, last_ip, ip_force, expire, donatemoney, email', 'safe', 'on'=>'search'),
			...
			array('id, name, password, activated, access_level, membership, last_ip, ip_force, expire, donatemoney', 'safe', 'on'=>'edit'),
			
			array('id, name, password, activated, access_level, membership, last_ip, ip_force, expire, donatemoney, email', 'safe', 'on'=>'membership'),
			
			array('name, email, captcha', 'required', 'on'=>'lost'),
			array('id, new_password, password, activated, access_level, membership, last_ip, ip_force, expire, donatemoney', 'safe', 'on'=>'lost'),
			
			array('donatemoney', 'required', 'on'=>'balance'),
			
			array('name, activated, access_level, membership, donatemoney', 'required', 'on'=>'admin_edit'),
	...
	public function search()
	{
		...
		//$criteria->compare('donatemoney',$this->donatemoney);
