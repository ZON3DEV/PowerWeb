	...
	*/
	public function rules()
	{
		return array(
			...
			array('id, account_id, heading, world_id, cube_size, advenced_stigma_slot_size, warehouse_size, mailboxLetters, bind_point, title_id, online, show_inventory, show_location', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, account_id, account_name, exp, recoverexp, x, y, z, heading, world_id, gender, race, player_class, creation_date, deletion_date, last_online, cube_size, advenced_stigma_slot_size, warehouse_size, mailboxLetters, bind_point, title_id, online, note', 'safe', 'on'=>'search'),
	...
	*/
	public function attributeLabels()
	{
		return array(
			...
			'cube_size' => 'Cube size',
			'advenced_stigma_slot_size' => 'Stigma slots',
