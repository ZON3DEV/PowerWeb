...
class AbyssRank extends CActiveRecord
{
	...
	*/
	...
	public function rules()
	{
		...
		return array(
			array('player_id, daily_ap, weekly_ap, ap, daily_kill, weekly_kill, last_kill, last_ap, last_update', 'required'),
			array('player_id, daily_ap, weekly_ap, ap, rank, top_ranking, old_ranking, daily_kill, weekly_kill, all_kill, max_rank, last_kill, last_ap', 'numerical', 'integerOnly'=>true),
			array('last_update', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('player_id, daily_ap, weekly_ap, ap, rank, top_ranking, old_ranking, daily_kill, weekly_kill, all_kill, max_rank, last_kill, last_ap, last_update', 'safe', 'on'=>'search'),
		);
	}
