...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		chart = new Highcharts.Chart({
			...
			title: {text: 'Allgemeine Statistiken'},
	...
	jQuery(document).ready(function() {
		chart = new Highcharts.Chart({
			...
			series: [{
				...
				name: 'Browser share',
				data: [
					['Asmodier',	<?php echo Status::online_asmo(); ?>],
	...
	jQuery(document).ready(function() {
		var colors = Highcharts.getOptions().colors,
			categories = ['Gladiator', 'Templar', 'Assassin', 'Ranger', 'Sorcerer', 'Spirit Master', 'Priest', 'Muse'],
			data = [{ 
					...
					y: <?php echo Status::player_class('ENGINEER'); ?>,
					color: colors[6],
				}, {
					y: <?php echo Status::player_class('MUSE'); ?>,
					color: colors[7],
				}];
